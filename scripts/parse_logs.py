"""
Parse our unreasonably large folder of json files into a network graph.
"""
import json
import time
import os
...
def main():
    ...
    parser.add_argument("-g", "--gamemodes", type=list, default=["sixes", "highlander"],  help="gamemodes to consider. trends provides sixes, highlander, ultiduo, fours, prolander, other")
